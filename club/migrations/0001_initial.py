    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted', models.BooleanField(default=False)),
                ('reward', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='crug_reward', to='club.reward')),
            ],
        ),
        migrations.CreateModel(
            name='RewardUsage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted', models.BooleanField(default=False)),
                ('reward', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='crr_reward', to='club.reward')),
            ],
        ),
        migrations.AddField(
            model_name='reward',
